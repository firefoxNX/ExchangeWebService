...
*/
@interface HEWSArrayOfResolutionType : NSObject <PicoBindable> {

@private
    NSMutableArray *_resolution;
...
/**
 ...
 entry type : class HEWSResolutionType
*/

@property (nonatomic, retain) NSMutableArray *resolution;
