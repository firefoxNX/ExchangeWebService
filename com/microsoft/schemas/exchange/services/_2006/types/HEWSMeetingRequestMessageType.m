...
@implementation HEWSMeetingRequestMessageType

@synthesize meetingRequestType = _meetingRequestType;
@synthesize intendedFreeBusyStatus = _intendedFreeBusyStatus;
...
+(NSMutableDictionary *)getPropertyMetaData {
    ...
    ps = [[PicoPropertySchema alloc] initWithKind:PICO_KIND_ELEMENT xmlName:@"MeetingRequestType" propertyName:@"meetingRequestType" type:PICO_TYPE_ENUM clazz:nil];
    [map setObject:ps forKey:@"meetingRequestType"];
    [ps release];
    ps = [[PicoPropertySchema alloc] initWithKind:PICO_KIND_ELEMENT xmlName:@"IntendedFreeBusyStatus" propertyName:@"intendedFreeBusyStatus" type:PICO_TYPE_ENUM clazz:nil];
    [map setObject:ps forKey:@"intendedFreeBusyStatus"];
    [ps release];
...
-(void)dealloc {
    self.meetingRequestType = nil;
    self.intendedFreeBusyStatus = nil;
    self.start = nil;
    self.end = nil;
