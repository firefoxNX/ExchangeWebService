...
@implementation HEWSMimeContentType
...
+(NSMutableDictionary *)getPropertyMetaData {
    ...
    [ps release];
    ps = [[PicoPropertySchema alloc] initWithKind:PICO_KIND_ATTRIBUTE xmlName:@"CharacterSet" propertyName:@"characterSet" type:PICO_TYPE_STRING clazz:nil];
    [map setObject:ps forKey:@"characterSet"];
    [ps release];
