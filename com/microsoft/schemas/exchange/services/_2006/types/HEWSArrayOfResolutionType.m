...
@implementation HEWSArrayOfResolutionType
...
+(NSMutableDictionary *)getPropertyMetaData {
    ...
    ps = [[PicoPropertySchema alloc] initWithKind:PICO_KIND_ELEMENT_ARRAY xmlName:@"Resolution" propertyName:@"resolution" type:PICO_TYPE_OBJECT clazz:[HEWSResolutionType class]];
    [map setObject:ps forKey:@"resolution"];
    [ps release];
