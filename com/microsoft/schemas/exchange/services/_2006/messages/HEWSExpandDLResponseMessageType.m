...
@implementation HEWSExpandDLResponseMessageType

@synthesize dlExpansion = _dlExpansion;
...
+(PicoClassSchema *)getClassMetaData {
    PicoClassSchema *cs = [[PicoClassSchema alloc] initWithXmlName:@"ExpandDLResponseMessage" nsUri:@"http://schemas.microsoft.com/exchange/services/2006/messages"];
    [cs autorelease];
    return cs;
}
...
+(NSMutableDictionary *)getPropertyMetaData {
    ...
    ps = [[PicoPropertySchema alloc] initWithKind:PICO_KIND_ELEMENT xmlName:@"DLExpansion" propertyName:@"dlExpansion" type:PICO_TYPE_OBJECT clazz:[HEWSArrayOfDLExpansionType class]];
    [map setObject:ps forKey:@"dlExpansion"];
    [ps release];
